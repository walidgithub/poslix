        ...
        child: Container(
          ...
          child: GridView.count(
              ...
              children: List.generate(
                  widget.itemOptions.length, (index) {
                return Bounceable(
                  ...
                  onTap: () async {
                    ...
                    widget.itemIndex]
                        .stock ==
                        0) {
                      CustomDialog.show(context,AppStrings.noCredit.tr(),const Icon(Icons.warning_amber_rounded),ColorManager.white,AppConstants.durationOfSnackBar,ColorManager.hold);
                      return;
                    }

                    int qty = widget
                        .selectedListName[widget.itemIndex]
                    ...
                    if (listOfTmpOrder.isNotEmpty){
                      int listOfTmpOrderIndex =
                      listOfTmpOrder.indexWhere(
                              (element) =>
                          element
                              .productId ==
                              widget
                    ...
                    setState(() {
                      for (var entry in listOfTmpOrder) {
                        ...
                        widget.itemIndex]
                          ...
                          entry.itemAmount = (itemCount *
                              double.parse(entry.itemPrice
                                  .toString()))
                              .toString();
                          return;
                        }
                      ...
                      String sellPrice =
                          widget.itemOptions[index].price;
                      ...
                      listOfTmpOrder.add(TmpOrderModel(
                        ...
                        widget.itemIndex]
                            ...
                            .toString(),
                        customerTel:
                        widget.selectedCustomerTel,
                        date: today.toString().split(" ")[0],
                        itemOption:
                        widget.itemOptions.isNotEmpty
                            ? widget
                            .selectedListName[
                        widget.itemIndex]
                            .variations[index]
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                textS14PrimaryComponent(context,AppStrings.remaining.tr()),
                              ],
                            ),
                            SizedBox(
                              height:
