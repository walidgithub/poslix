...
abstract class POSRepository {
  ...
  Future<void> addCustomer(final String token, final CustomerRequest parameters, final int locationId);
  Future<void> updateCustomer(final int customerId, final String token, final CustomerRequest parameters);
  Future<List<PricingGroupResponse>> getPricingGroups(final String token, final int locationId);
